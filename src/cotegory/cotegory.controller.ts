...
export class CategoryController {
  ...
  @ApiResponse({ status: 201, description: 'Category created successfully' }) // Описание успешного ответа
  ...
  @ApiResponse({ status: 200, description: 'List of categories' }) // Описание успешного ответа
  async findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Category found' }) // Описание успешного ответа
  ...
  @ApiBody({ type: CreateCategoryDto }) // Описание тела запроса
  @ApiResponse({ status: 200, description: 'Category updated successfully' }) // Описание успешного ответа
  @ApiResponse({ status: 400, description: 'Invalid input data' }) // Описание ошибки
